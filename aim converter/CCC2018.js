...
module.exports = function CCC2018jsonToAim(jsonObj){
    console.log("json")
    const seedData = {};
    seedData.aim = {};
    seedData.study = {};
    ...
    seedData.person.patientId = jsonObj['SubjectID'];
    seedData.person.birthDate = "";

    const sopInstanceUid = jsonObj['ReferencedSOPSequence.ReferencedSOPInstanceUID']
    const sopClassUid = jsonObj['ReferencedSOPSequence.ReferencedSOPClassUID']

    // generate CCC template characteristics

    theChar = (getCharacteristicsData("Finding", jsonObj['Finding.CodeMeaning'] ))
    seedData.aim.imagingObservationEntityCollection = {
        "ImagingObservationEntity": [theChar]
    };

    thePhys = (getCharacteristicsData("Location", jsonObj['Finding Site.CodeMeaning'] ))
    ...
    const answers = getTemplateAnswers(seedData, jsonObj[''], '');
    ...
    // short axis
    x1 = jsonObj['ShortAxis.point1.x']
    x2 = jsonObj['ShortAxis.point2.x']
    y1 = jsonObj['ShortAxis.point1.y']
    y2 = jsonObj['ShortAxis.point2.y']
    ...
    // long axis
    x1 = jsonObj['LongAxis.point1.x']
    x2 = jsonObj['LongAxis.point2.x']
    y1 = jsonObj['LongAxis.point1.y']
    y2 = jsonObj['LongAxis.point2.y']
