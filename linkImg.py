...
def getData(f):
    ...
    for n in nodes:
        ...
        for r in rois:
            ...
            d = ["Nodule", ID, subtlety, internalStructure, calcification,  sphericity, margin, lobulation, spiculation, texture, malignancy, z_pos, UID, xys]
            data.append(d)
